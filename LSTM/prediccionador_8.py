...
#limpiamos la base
#cursor.execute("""TRUNCATE TABLE prediccionador_8""")
#conn.commit()
...
while True:
    ...
    if  ((valor != replica_valor) or replica_valor is None) :
        ...
        #la enviamos a la db
        cursor.execute("""INSERT INTO prediccionador_8 (previa_y, previa_diferencia, previa_prediccion, valor, class, x, y, diferencia, prediccion) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)""",(previa_ynew, previa_diferencia, previa_prediccion,  valor, clase, cadena_x, ynew, diferencia, prediccion))
        conn.commit()