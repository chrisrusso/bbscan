...
while True:
    ...
    if  ((informacion_xnew != replica_xnew).any() or replica_xnew is None) :
        ...
        #la enviamos a la db
        cursor.execute("""INSERT INTO prediccionador_6 (prediccion_previa, valor, x, y, diferencia, prediccion) VALUES (%s,%s,%s,%s,%s,%s)""",(prediccion_previa, valor, cadena_x, cadena_y, diferencia, prediccion))
        conn.commit()
