<?php
    ...
    if ($ahora >= "09:58" and $ahora < "11:02") { echo "\r\n Informacion: [10] o'clock"; $params->sys = 'on'; }
    if ($ahora >= "01:58" and $ahora < "03:02") { echo "\r\n Informacion: [02] o'clock"; $params->sys = 'on'; }
    ...
    if ($params->sys == 'on') {
        ...
        while (1 == 1) {
            ...
            if ($player->lhash != $info->lround_hash && $player->accion == 'on') {
                ...
                if ($ahora >= "15:58" and $ahora < "17:02") { $params->sys = 'on'; }
                if ($ahora >= "12:58" and $ahora < "14:02") { $params->sys = 'on'; }
                if ($ahora >= "07:58" and $ahora < "09:02") { $params->sys = 'on'; }
                if ($ahora >= "09:58" and $ahora < "11:02") { $params->sys = 'on'; }
                if ($ahora >= "01:58" and $ahora < "03:02") { $params->sys = 'on'; }
